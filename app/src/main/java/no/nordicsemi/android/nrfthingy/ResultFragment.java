...
public class ResultFragment extends Fragment {
    ...
    public static ResultFragment newInstance(ArrayList<BluetoothDevice> mDeviceList) {
    ...
    private class ListViewAdapter extends BaseAdapter {
        ...
        public ListViewAdapter() {
            ...
            inflater = ResultFragment.this.getLayoutInflater();
        }
        ...
        public void addDevice(BluetoothDevice device) {
            ...
            if(!mListData.contains(addInfo)) {
                Log.d("ResultFragment : ", device.getAddress());
        ...
        public void changeImg(BluetoothDevice device, String status) {
            Log.d("ResultFragment : ", String.valueOf(mBleList.indexOf(device)));
            if(status.equals("0"))
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            final ResultFragment.ViewHolder holder;
            if (convertView == null) {
                Log.d("ListView : ", mListData.get(position).mDevice.getAddress());
                holder = new ResultFragment.ViewHolder();
...
//                        mBluetoothLeService.setCharacteristicNotification(mGattList.get(i), mBluetoothLeService.mClassificationCharacteristic, isChecked);
                ...
                Log.d("ResultFragment", "button is null");
            }
    ...
    private ThingyListener mThingyListener = new ThingyListener() {
        ...
        @Override
        public void onResultVectorValueChangedEvent(BluetoothDevice bluetoothDevice, String len, String R_0, String R_1, String R_2, String R_3, String R_4, String R_5, String R_6, String R_7, String R_8, String R_9, String R_10, String R_11, String R_12, String R_13, String R_14, String R_15) {
